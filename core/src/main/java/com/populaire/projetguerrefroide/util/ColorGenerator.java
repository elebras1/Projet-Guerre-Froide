...
public class ColorGenerator {
    ...
    public static int getRedToGreenGradientRGBA(int value, int range) {
    ...
    public static int getMagmaColorRGBA(float percent) {
        percent = Math.max(0f, Math.min(1f, percent));

        int index = (int)(percent * 255f);
        index = Math.max(0, Math.min(index, 255));

        int red = (int)(magma[index][0] * 255f);
        int green = (int)(magma[index][1] * 255f);
        int blue = (int)(magma[index][2] * 255f);
