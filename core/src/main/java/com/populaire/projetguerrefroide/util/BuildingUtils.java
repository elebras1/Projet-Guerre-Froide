...
public class BuildingUtils {
    public static String getColor(String building) {
        return switch (building) {
            ...
            case "integrated_circuits_factory", "electronic_components_factory", "computers_factory", "communication_factory" -> "blue";
            case "machine_parts_factory", "automobiles_factory" -> "darkblue";
            case "multimodal_transport", "ships_factory", "aeroplanes_factory" -> "yellow";
            case "ammunition_factory", "weaponry_factory", "armoured_vehicles_factory", "military_satellites_factory", "centrifuges" -> "cyan";
